...
export interface BoxInterface extends utils.Interface {
  ...
  events: {
    ...
    "ValuChanged(uint256)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "OwnershipTransferred"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "ValuChanged"): EventFragment;
}
...
export interface ValuChangedEventObject {
  newValue: BigNumber;
}
export type ValuChangedEvent = TypedEvent<[BigNumber], ValuChangedEventObject>;

export type ValuChangedEventFilter = TypedEventFilter<ValuChangedEvent>;
...
export interface Box extends BaseContract {
  ...
  filters: {
    ...
    "ValuChanged(uint256)"(newValue?: null): ValuChangedEventFilter;
    ValuChanged(newValue?: null): ValuChangedEventFilter;
  };
