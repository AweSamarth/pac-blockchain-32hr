...
async function main(){
    ...
    // so we have to use weth and not eth

    const {deployer} = await getNamedAccounts()

    //lending pool address provider 0xB53C1a33016B2DC2fF3653530bfF1848a515c8c5
    // the actual address of the lending pool will be taken using the above line
    ...
    await borrowDai(daiTokenAddress, lendingPool, amountDaiToBorrowWei)
...
async function getDaiPrice(){
      ...
      // we don't use a deployer here because we are only calling read functions.
